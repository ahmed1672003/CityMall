        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhatsAppNumber = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ChangePasswordCode = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    FileName = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: true),
                    FilePath = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId1 = table.Column<string>(type: "nvarchar(64)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    RoleId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    UserId1 = table.Column<string>(type: "nvarchar(64)", nullable: true),
                    RoleId1 = table.Column<string>(type: "nvarchar(64)", nullable: true)
                },
                constraints: table =>
                {
